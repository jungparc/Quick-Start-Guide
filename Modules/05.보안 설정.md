...
* **네트워크 보안 설정**
    * VPC 및 서브넷 구성을 통한 네트워크 분리 및 보호하기
    * 보안 그룹과 ACL(Access Control List) 설정해 허가된 트래픽만 허용하기
* **데이터 보안**  // 내용 관련성 확인 필요
    * NHN Cloud에서 제공하는 데이터 암호화 방식 및 스토리지 보안 설정하기
    * 데이터 손실 대비 위한 백업 및 복구 전략 학습하기
...
## 시나리오 3. Network ACL 설정으로 특정 네트워크 대역 통신 차단하기 
